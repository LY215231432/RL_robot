# Reconstructed version 02: add end-effector verticality.
# Idea: keep TCP vertical to avoid side insertion into the cap.
...
class RewardTerms:
    ...
    descend_to_grasp = RewTerm(
        ...
        params={"xy_std": 0.02, "z_std": 0.015, "grasp_height": 0.018, "close_joint_pos": 0.85, "vertical_axis_index": 2, "vertical_target_sign": -1.0},
        weight=7.0,
    )
    grasp_cap = RewTerm(
        func=mdp.grasp_cap,
