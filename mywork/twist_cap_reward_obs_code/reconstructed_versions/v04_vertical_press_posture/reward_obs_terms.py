# Reconstructed version 04: add vertical-press joint posture gate.
# Idea: keep a top-down-friendly arm posture, and only strongly reward descent when this posture is reasonable.
